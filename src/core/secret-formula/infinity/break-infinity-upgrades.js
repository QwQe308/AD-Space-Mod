...
export const breakInfinityUpgrades = {
  totalAMMult: {
    id: "totalMult",
    cost: 1e4,
    description: "Antimatter Dimensions & Researches gain a multiplier based on total antimatter produced",
    effect: () => Math.pow(player.records.totalAntimatter.exponent + 1, 0.4),
    formatEffect: (value) => formatX(value, 2, 2),
  },
  currentAMMult: {
    id: "currentMult",
    cost: 5e4,
    description: "Antimatter Dimensions & Researches gain a multiplier based on current antimatter",
  ...
  infinitiedMult: {
    id: "infinitiedMult",
    cost: 1e5,
    description: "Antimatter Dimensions & Researches gain a multiplier based on Infinities",
    effect: () => (1 + Currency.infinitiesTotal.value.pLog10() * 2) ** 2,
    formatEffect: (value) => formatX(value, 2, 2),
  },
  achievementMult: {
    id: "achievementMult",
    cost: 1e6,
    description: "Additional multiplier to Antimatter Dimensions & Researches based on Achievements completed",
  ...
  slowestChallengeMult: {
    ...
    effect: () => Decimal.clampMin(50 / Time.worstChallenge.totalMinutes, 1).pow(1.33),
    formatEffect: (value) => formatX(value, 2, 2),
    hasCap: true,
    cap: DC.D3E4,
  },
  infinitiedGen: {
    ...
    formatEffect: (value) => {
      ...
      const timeStr =
        Time.bestInfinity.totalMilliseconds <= 50
