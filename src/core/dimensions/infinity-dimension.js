...
export const InfinityDimensions = {
  ...
  get powerConversionRate() {
    let base = 7 + getAdjustedGlyphEffect("infinityrate") + PelleUpgrade.infConversion.effectOrDefault(0);
    base += SpaceResearchRifts.r45.effectValue.toNumber();
